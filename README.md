...
## 🛠️ TECHNOLOGY STACK (aka the arsenal of sleepless nights)
...
- 50+ Production Deployments – survived production hell
- Open Source Contributor – chaos for the community
...
const safwanGanz = {
    ...
    technologies: {
        frontend: { javascript: ["React", "Vue.js", "Next.js"], styling: ["Tailwind CSS","Bootstrap","Material UI"] },
        backend: { javascript:["Node.js","Express.js"], python:["Django","Flask"], infrastructure:["Bash","Systemd","Nginx"] },
        databases: ["MongoDB","MySQL","PostgreSQL"], cloud:["AWS","Google Cloud Platform","Docker","Kubernetes"]
    },
...
- Cross-Platform Mobile Development – breaking things everywhere
- AI/ML Integration – code that judges you back
- Open Source Leadership – spreading chaos for the community
- Knowledge Sharing – teaching people how to suffer beautifully
...
- Code is like humor: if you need to explain it, you failed
- Debugging advocate: `console.log()` is my therapy
- Curated playlists make me slightly less insane
- Coffee is life
...
open for collabs, learning, and pure chaos.
